...
contract JoinCoinStaking is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        rewardToken = IBEP20(0xaEF6C981F821B529a3b074Bf8Bbee65803381969);
        rewardPerBlock = 0.1 ether;
    ...
    function deposit(uint256 _amount) public nonReentrant {
        ...
        if(_amount > 0) {
            ...
            uint256 amountTransferred = pool.lpToken.balanceOf(address(this)) - initialBalance;
